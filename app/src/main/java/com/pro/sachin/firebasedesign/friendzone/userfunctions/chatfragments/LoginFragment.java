package com.pro.sachin.firebasedesign.friendzone.userfunctions.chatfragments;
...
import com.pro.sachin.firebasedesign.friendzone.functionalities.userlogin.LoginContract;
import com.pro.sachin.firebasedesign.friendzone.functionalities.userlogin.LoginPresenter;
import com.pro.sachin.firebasedesign.friendzone.userfunctions.chatactivities.RegisterActivity;
import com.pro.sachin.firebasedesign.friendzone.userfunctions.chatactivities.UserListingActivity;
...
public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View {
    ...
    private void bindViews(View view) {
        ...
        mBtnLogin.setBackgroundResource(R.drawable.tab_indicator);
        mBtnRegister = (Button) view.findViewById(R.id.button_register);
        mBtnRegister.setBackgroundResource(R.drawable.tab_indicator);
    }
    ...
    private void setDummyCredentials() {
        mETxtEmail.setHint("XYZ@Example.com");
        mETxtPassword.setHint("1234");
       // mETxtEmail.setText("XYZ@Example.com");
